...
import com.creactiviti.piper.taskhandler.trigger.Cron;
...
@SpringBootTest
public class CronCoordinatorTests {
  ...
  public void testStartJob () throws SQLException {
    ...
    handlers.put("trigger/cron", new Cron());
    ...
    Job job = coordinator.create(MapObject.of(ImmutableMap.of("pipelineId","demo/cron","inputs", Map.of("cron","* * * * * *", "yourName", "Bohan"))));
